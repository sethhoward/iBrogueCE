...
unsigned int glyphToUnicode(enum displayGlyph glyph) {
    ...
    if (graphicsMode == TILES_GRAPHICS || (graphicsMode == HYBRID_GRAPHICS && isEnvironmentGlyph(glyph))) return (glyph-130)+0x4000;
    switch (glyph) {
        ...
        case G_KEY: return  '-';
        case G_BOG: return  '~';
        case G_CHAIN_TOP_LEFT: return  '\\';
        case G_CHAIN_BOTTOM_RIGHT: return  '\\';
        case G_CHAIN_TOP_RIGHT: return  '/';
        case G_CHAIN_BOTTOM_LEFT: return  '/';
        case G_CHAIN_TOP: return  '|';
        case G_CHAIN_BOTTOM: return  '|';
        case G_CHAIN_LEFT: return  '-';
        case G_CHAIN_RIGHT: return  '-';
        case G_FOOD:  return  ';';
        ...
        case G_BAD_MAGIC:  return  U_FILLED_CIRCLE_BARS;
